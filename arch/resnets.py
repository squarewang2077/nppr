...
from torchvision.models import resnet34 as _resnet34, ResNet34_Weights
...
def resnet34(num_classes: int, pretrained: bool = False) -> nn.Module:
    weights = ResNet34_Weights.IMAGENET1K_V1 if pretrained else None
    model = _resnet34(weights=weights)
    model.fc = nn.Linear(model.fc.in_features, num_classes)
    return model
