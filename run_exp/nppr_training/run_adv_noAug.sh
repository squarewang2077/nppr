#!/bin/bash
# run_adv_noAug.sh
# PGD-AT / TRADES adversarial training (NO data augmentation) of
...
TRAINING_TYPE="trades"       # standard | adv_pgd | trades
...
echo "  Training Type: ${TRAINING_TYPE}  (no data augmentation)"
echo "======================================================"
echo ""
...
echo ""
echo "All ${TRAINING_TYPE} (no-aug) training runs completed."
